<template>
  <div class="welcome">
    <h1>欢迎访问人文学院教育教学实践中心教室借用管理系统后台</h1>
    <p>
      人文学院教育教学实践中心教室借用管理系统，是由睿信社区技术保障中心代为开发的综合后台管理系统
    </p>
    <p>目前 BITRXC 的功能包括: </p>
    <ul>
      <li>订单列表 —— 审批由微信小程序发起的预约</li>
      <li>订单管理 —— 以类似于课程表的视图，查看某房间的占用情况</li>
      <li>管理员列表 —— 管理不同的管理员</li>
      <li>活动室预约 —— 管理员批量预约活动室</li>
      <li>房间列表 —— 修改房间信息</li>
      <li>用户列表 —— 管理并审核系统内注册的用户</li>
    </ul>
    <figure>
    ...
    <p>
      睿信社区技术保障中心官网：<a href="https://bitrxc.com/">https://bitrxc.com/</a>
    </p>
  </div>
</template>
